...
public class Note implements Comparable {
    ...
    private long tick;
    private long duration = -1;             //length in ticks
    private long distanceFromPrevious = -1; //time in ticks from the start of the previous
     ...
     */
    public Note(int trackNumber, long tick, ShortMessage message) throws InvalidMidiDataException {
    ...
    /**
     * Overrides method to make a sting from a note to write it in the console
     * @return a string with all the information about the note
     */
    @Override
    ...
    /**
     * Overrides a method to compare two notes
     * @param o second note to be compared
     * @return 0 when the notes are identical, 1 the first note is bigger, -1 the first note is smaller
     */
    @Override
